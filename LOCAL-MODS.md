...
for b in fix/task-owner-attribution fix/task-agent-wall-clock-timeout fix/app-bind-host feat/task-grounding-url-fetch fix/web-fetch-private-ip-guard fix/task-result-delivery fix/memory-mcp-owner feat/task-board feat/bridge-review feat/contact-notes meta/local-mods-guide; do
  echo "==> rebasing $b"
...
git merge --no-edit fix/task-owner-attribution fix/task-agent-wall-clock-timeout fix/app-bind-host feat/task-grounding-url-fetch fix/web-fetch-private-ip-guard fix/task-result-delivery fix/memory-mcp-owner feat/task-board feat/bridge-review feat/contact-notes meta/local-mods-guide

# 5. (optional) push the re-seated branches to your fork
git push --force-with-lease fork \
  fix/task-owner-attribution fix/task-agent-wall-clock-timeout fix/app-bind-host feat/task-grounding-url-fetch fix/web-fetch-private-ip-guard fix/task-result-delivery fix/memory-mcp-owner feat/task-board feat/bridge-review feat/contact-notes meta/local-mods-guide
```
