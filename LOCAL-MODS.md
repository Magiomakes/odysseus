...
for b in fix/task-owner-attribution fix/task-agent-wall-clock-timeout fix/app-bind-host feat/task-grounding-url-fetch fix/web-fetch-private-ip-guard fix/task-result-delivery fix/memory-mcp-owner feat/task-board feat/task-lifecycle feat/bridge-review feat/contact-notes feat/morning-brief feat/captures-mcp feat/memory-projection fix/agent-loop-any-import meta/local-mods-guide; do
  echo "==> rebasing $b"
...
git merge --no-edit fix/task-owner-attribution fix/task-agent-wall-clock-timeout fix/app-bind-host feat/task-grounding-url-fetch fix/web-fetch-private-ip-guard fix/task-result-delivery fix/memory-mcp-owner feat/task-board feat/task-lifecycle feat/bridge-review feat/contact-notes feat/morning-brief feat/captures-mcp feat/memory-projection fix/agent-loop-any-import meta/local-mods-guide
